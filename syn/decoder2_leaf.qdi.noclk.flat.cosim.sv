...
module decoder2_leaf_cosim_wrapper(interface In, interface Out0, interface Out1, interface S, input _RESET);

 decoder2_leaf decoder2_leaf_expanded (In.e[0] , In.e[1] , In.e[2] , In.e[3] , In.e[4] , In.e[5] 
...
module decoder2_leaf (\In_e[0] , \In_e[1] , \In_e[2] , \In_e[3] , \In_e[4] , \In_e[5] , \In_e[6] , \In_e[7] , \In_e[8] , 
  ...
  wire   \n_73_FX3_34.e , \n_73_FX3_a.0 , \n_73_FX3_a.1 , \n_73_FX3_b.0 , \n_73_FX3_b.1 , \n_73_SX0_iter2.0 , \n_73_SX0_iter2.1 ;
  wire   \n_73_SX0_iter2.e , \n_75.0 , \n_75.1 , \n_76.0 , \n_76.1 , \n_77.0 , \n_77.1 , \n_78.0 , \n_78.1 , \n_79.0 , \n_79.1 ;
  wire   \n_80.0 , \n_80.1 , \n_81.0 , \n_81.1 , \n_82.0 , \n_82.1 , \pchb_cfbuf_58_FX_inst_n_73_SX0_iter2_0e ;
  wire   \pchb_cfbuf_58_FX_inst_n_73_SX0_iter2_1e , \pchb_cfbuf_59_FX_inst_n_73_0e , \pchb_cfbuf_59_FX_inst_n_73_1e ;
  ...
  trireg \pchb_cloud_33_inst_en0 , \pchb_cloud_52_inst_en0 , \pchb_cloud_52_inst_en3 , \pchb_cloud_53_inst_en0 ;
  ...
  \synthesis.qdi.special.BUF.2 \pchb_cloud_29_inst_In_RECEIVE.recv.bits[4].recv ( 
    ...
    .\R.1 ( \d[4].1 ), 
    .\R.e ( \c53.e ));
  \synthesis.qdi.special.BUF.2 \pchb_cloud_30_inst_In_RECEIVE.recv.bits[5].recv ( 
    ._RESET ( _RESET ), 
    .\L.0 ( \In_d[0][5] ), 
    .\L.1 ( \In_d[1][5] ), 
    .\L.e ( \In_e[5] ), 
  ...
  \synthesis.qdi.special.BUF.2 \pchb_cloud_32_inst_In_RECEIVE.recv.bits[7].recv ( 
    ...
    .\R.1 ( \d[7].1 ), 
    .\R.e ( \c52.e ));
  \synthesis.qdi.special.BUF.4 \pchb_cloud_33_inst_In_RECEIVE.recv.bits[8].recv ( 
    ._RESET ( _RESET ), 
    .\L.0 ( \In_d[0][8] ), 
    .\L.1 ( \In_d[1][8] ), 
    .\L.e ( \In_e[8] ), 
  ...
  \synthesis.qdi.special.CTREE4.2 \pchb_cloud_33_inst_In_RECEIVE.recv.bits[8].recv_companion0 ( 
  ...
  \synthesis.qdi.special.SEND_1of2.2 \pchb_cloud_43_inst_Out0_SEND.send.bits[8].send ( 
    ...
    .\R.0 ( \Out0_d[0][8] ), 
    .\R.1 ( \Out0_d[1][8] ));
  \synthesis.qdi.logic2.LOGIC2_1.2 \decoder2_leaf_RTL_BODY.g529 ( 
    ...
    .\X.0 ( \n_75.0 ), 
    .\X.1 ( \n_75.1 ));
  \synthesis.qdi.logic2.LOGIC2_1.2 \decoder2_leaf_RTL_BODY.g530 ( 
    ...
    .\X.0 ( \n_76.0 ), 
    .\X.1 ( \n_76.1 ));
  \synthesis.qdi.logic2.LOGIC2_1.2 \decoder2_leaf_RTL_BODY.g536 ( 
    ...
    .\X.0 ( \n_55.0 ), 
    .\X.1 ( \n_55.1 ));
  \synthesis.qdi.logic2.LOGIC2_1.2 \decoder2_leaf_RTL_BODY.g538 ( 
    ...
    .\X.0 ( \n_56.0 ), 
    .\X.1 ( \n_56.1 ));
  \synthesis.qdi.special.CTREE2.2 \ctreedecoder2_leaf_RTL_BODY.g538 ( 
  ...
  \synthesis.qdi.special.CTREE4.2 \ctreedecoder2_leaf_RTL_BODY.g529 ( 
    .\a[0] ( \pchb_cloud_52_inst_go ), 
    .\a[1] ( \c23.e ), 
    .\a[2] ( \c42.e ), 
    .\a[3] ( \c41.e ), 
    .x ( \pchb_cloud_52_inst_en0 ));
  \synthesis.qdi.logic2.LOGIC2_1.2 \decoder2_leaf_RTL_BODY.g531 ( 
    ...
    .\X.0 ( \n_61.0 ), 
    .\X.1 ( \n_61.1 ));
  \synthesis.qdi.logic2.LOGIC2_1.2 \decoder2_leaf_RTL_BODY.g532 ( 
    ...
    .\X.0 ( \n_78.0 ), 
    .\X.1 ( \n_78.1 ));
  \synthesis.qdi.logic2.LOGIC2_1.2 \decoder2_leaf_RTL_BODY.g539 ( 
    ...
    .\X.0 ( \n_58.0 ), 
    .\X.1 ( \n_58.1 ));
  \synthesis.qdi.special.CTREE2.2 \ctreedecoder2_leaf_RTL_BODY.g539 ( 
    .x ( \pchb_cloud_53_inst_en3 ), 
    .\a[0] ( \pchb_cloud_53_inst_go ), 
    .\a[1] ( \c20.e ));
  \synthesis.qdi.logic2.LOGIC2_1.2 \decoder2_leaf_RTL_BODY.g544 ( 
  ...
  \synthesis.qdi.special.CTREE4.2 \ctreedecoder2_leaf_RTL_BODY.g531 ( 
    .\a[0] ( \pchb_cloud_53_inst_go ), 
    .\a[1] ( \c17.e ), 
    .\a[2] ( \c39.e ), 
    .\a[3] ( \c36.e ), 
    .x ( \pchb_cloud_53_inst_en0 ));
  \synthesis.qdi.logic2.LOGIC2_1.2 \decoder2_leaf_RTL_BODY.g533 ( 
    ...
    .\X.0 ( \n_59.0 ), 
    .\X.1 ( \n_59.1 ));
  \synthesis.qdi.logic2.LOGIC2_1.2 \decoder2_leaf_RTL_BODY.g534 ( 
    ...
    .\X.0 ( \n_82.0 ), 
    .\X.1 ( \n_82.1 ));
  \synthesis.qdi.logic2.LOGIC2_1.2 \decoder2_leaf_RTL_BODY.g537 ( 
    ...
    .\X.0 ( \n_79.0 ), 
    .\X.1 ( \n_79.1 ));
  \synthesis.qdi.logic2.LOGIC2_1.2 \decoder2_leaf_RTL_BODY.g543 ( 
    ...
    .\X.0 ( \n_62.0 ), 
    .\X.1 ( \n_62.1 ));
  \synthesis.qdi.special.CTREE2.2 \ctreedecoder2_leaf_RTL_BODY.g543 ( 
  ...
  \synthesis.qdi.special.CTREE4.2 \ctreedecoder2_leaf_RTL_BODY.g533 ( 
    .\a[0] ( \pchb_cloud_54_inst_go ), 
    .\a[1] ( \c19.e ), 
    .\a[2] ( \c38.e ), 
    .\a[3] ( \c35.e ), 
    .x ( \pchb_cloud_54_inst_en0 ));
  \synthesis.qdi.logic2.LOGIC2_1.2 \decoder2_leaf_RTL_BODY.g535 ( 
    ...
    .\X.0 ( \n_57.0 ), 
    .\X.1 ( \n_57.1 ));
  \synthesis.qdi.logic2.LOGIC2_1.2 \decoder2_leaf_RTL_BODY.g540 ( 
    ...
    .\X.0 ( \n_77.0 ), 
    .\X.1 ( \n_77.1 ));
  \synthesis.qdi.logic2.LOGIC2_1.2 \decoder2_leaf_RTL_BODY.g541 ( 
    ...
    .\X.0 ( \n_80.0 ), 
    .\X.1 ( \n_80.1 ));
  \synthesis.qdi.logic2.LOGIC2_1.2 \decoder2_leaf_RTL_BODY.g542 ( 
    ...
    .\X.0 ( \n_60.0 ), 
    .\X.1 ( \n_60.1 ));
  \synthesis.qdi.special.CTREE2.2 \ctreedecoder2_leaf_RTL_BODY.g542 ( 
  ...
  \synthesis.qdi.special.CTREE4.2 \ctreedecoder2_leaf_RTL_BODY.g535 ( 
    .\a[0] ( \pchb_cloud_55_inst_go ), 
    .\a[1] ( \c21.e ), 
    .\a[2] ( \c40.e ), 
    .\a[3] ( \c37.e ), 
    .x ( \pchb_cloud_55_inst_en0 ));
  \synthesis.qdi.special.BUF.4 \pchb_cfbuf_56_FX_inst_n_73_buf ( 
    ._RESET ( _RESET ), 
    .\L.0 ( \n_73.0 ), 
    .\L.1 ( \n_73.1 ), 
    .\L.e ( \n_73_56.e ), 
  ...
  \synthesis.qdi.special.CTREE4.2 \pchb_cfbuf_56_FX_inst_n_73_buf_companion0 ( 
    .x ( \pchb_cfbuf_56_FX_inst_en0 ), 
    .\a[0] ( \c42.e ), 
    .\a[1] ( \c41.e ), 
    .\a[2] ( \c40.e ), 
    .\a[3] ( \c39.e ));
  \synthesis.qdi.special.BUF.4 \pchb_cfbuf_57_FX_inst_n_73_buf ( 
    ._RESET ( _RESET ), 
    .\L.0 ( \n_73.0 ), 
    .\L.1 ( \n_73.1 ), 
    .\L.e ( \n_73_57.e ), 
  ...
  \synthesis.qdi.special.CTREE4.2 \pchb_cfbuf_57_FX_inst_n_73_buf_companion0 ( 
  ...
  \synthesis.qdi.special.CTREE2.2 \pchb_cfbuf_58_FX_inst_Le_merge ( 
    .x ( \n_73_SX0_iter2.e ), 
    .\a[0] ( \pchb_cfbuf_58_FX_inst_n_73_SX0_iter2_0e ), 
    .\a[1] ( \pchb_cfbuf_58_FX_inst_n_73_SX0_iter2_1e ));
  ...
  \synthesis.qdi.special.CTREE4.2 \pchb_cfbuf_58_FX_inst_Re_b_merge ( 
    ...
    .\a[2] ( \c17.e ), 
    .\a[3] ( \c16.e ));
  \synthesis.qdi.special.BUF.6 \pchb_cfbuf_58_FX_inst_n_73_buf ( 
    ._RESET ( _RESET ), 
    .\L.0 ( \n_73_SX0_iter2.0 ), 
    .\L.1 ( \n_73_SX0_iter2.1 ), 
    .\L.e ( \pchb_cfbuf_58_FX_inst_n_73_SX0_iter2_0e ), 
    .\R.0 ( \n_73_FX2_a.0 ), 
    .\R.1 ( \n_73_FX2_a.1 ), 
    .\R.e ( \pchb_cfbuf_58_FX_inst_en0 ));
  \synthesis.qdi.special.BUF.6 \pchb_cfbuf_58_FX_inst_n_73_buf2 ( 
    ._RESET ( _RESET ), 
    .\L.0 ( \n_73_SX0_iter2.0 ), 
    .\L.1 ( \n_73_SX0_iter2.1 ), 
    .\L.e ( \pchb_cfbuf_58_FX_inst_n_73_SX0_iter2_1e ), 
    .\R.0 ( \n_73_FX2_b.0 ), 
    .\R.1 ( \n_73_FX2_b.1 ), 
    .\R.e ( \pchb_cfbuf_58_FX_inst_en1 ));
  \synthesis.qdi.special.CTREE2.2 \pchb_cfbuf_59_FX_inst_Le_merge ( 
    .x ( \n_73_59.e ), 
    .\a[0] ( \pchb_cfbuf_59_FX_inst_n_73_0e ), 
    .\a[1] ( \pchb_cfbuf_59_FX_inst_n_73_1e ));
  ...
  \synthesis.qdi.special.CTREE4.2 \pchb_cfbuf_59_FX_inst_Re_b_merge ( 
    ...
    .\a[2] ( \n_73_FX3_34.e ), 
    .\a[3] ( \c24.e ));
  \synthesis.qdi.special.BUF.6 \pchb_cfbuf_59_FX_inst_n_73_buf ( 
    ._RESET ( _RESET ), 
    .\L.0 ( \n_73.0 ), 
    .\L.1 ( \n_73.1 ), 
    .\L.e ( \pchb_cfbuf_59_FX_inst_n_73_0e ), 
    .\R.0 ( \n_73_FX3_a.0 ), 
    .\R.1 ( \n_73_FX3_a.1 ), 
    .\R.e ( \pchb_cfbuf_59_FX_inst_en0 ));
  \synthesis.qdi.special.BUF.6 \pchb_cfbuf_59_FX_inst_n_73_buf2 ( 
    ._RESET ( _RESET ), 
    .\L.0 ( \n_73.0 ), 
    .\L.1 ( \n_73.1 ), 
    .\L.e ( \pchb_cfbuf_59_FX_inst_n_73_1e ), 
    .\R.0 ( \n_73_FX3_b.0 ), 
    .\R.1 ( \n_73_FX3_b.1 ), 
    .\R.e ( \pchb_cfbuf_59_FX_inst_en1 ));
  \synthesis.qdi.special.BUF.2 \pchb_cfbuf_60_SX_inst_n_73_buf ( 
    ._RESET ( _RESET ), 
    .\L.0 ( \n_73.0 ), 
    .\L.1 ( \n_73.1 ), 
    .\L.e ( \n_73_60.e ), 
