...
module decoder9_cosim_wrapper(interface In, interface Out0, interface Out1, interface S, input _RESET);

 decoder9 decoder9_expanded (In.e[0] , In.e[1] , In.e[2] , In.e[3] , In.e[4] , In.e[5] 
...
module decoder9 (\In_e[0] , \In_e[1] , \In_e[2] , \In_e[3] , \In_e[4] , \In_e[5] , \In_e[6] , \In_e[7] , \In_e[8] , 
  ...
  \synthesis.qdi.special.SEND_1of2.2 \pchb_cloud_43_inst_Out0_SEND.send.bits[8].send ( 
    ...
    .\R.0 ( \Out0_d[0][8] ), 
    .\R.1 ( \Out0_d[1][8] ));
  \synthesis.qdi.logic2.LOGIC2_1.2 \decoder9_RTL_BODY.g549 ( 
    ...
    .\X.0 ( \n_72.0 ), 
    .\X.1 ( \n_72.1 ));
  \synthesis.qdi.logic2.LOGIC2_1.2 \decoder9_RTL_BODY.g550 ( 
    ...
    .\X.0 ( \n_74.0 ), 
    .\X.1 ( \n_74.1 ));
  \synthesis.qdi.logic2.LOGIC2_1.2 \decoder9_RTL_BODY.g556 ( 
    ...
    .\X.0 ( \n_54.0 ), 
    .\X.1 ( \n_54.1 ));
  \synthesis.qdi.logic2.LOGIC2_1.2 \decoder9_RTL_BODY.g558 ( 
    ...
    .\X.0 ( \n_55.0 ), 
    .\X.1 ( \n_55.1 ));
  \synthesis.qdi.special.CTREE2.2 \ctreedecoder9_RTL_BODY.g558 ( 
  ...
  \synthesis.qdi.special.CTREE4.2 \ctreedecoder9_RTL_BODY.g549 ( 
    .\a[0] ( \pchb_cloud_52_inst_go ), 
    .\a[1] ( \c24.e ), 
    .\a[2] ( \c43.e ), 
    .\a[3] ( \c42.e ), 
    .x ( \pchb_cloud_52_inst_en0 ));
  \synthesis.qdi.logic2.LOGIC2_1.2 \decoder9_RTL_BODY.g551 ( 
    ...
    .\X.0 ( \n_60.0 ), 
    .\X.1 ( \n_60.1 ));
  \synthesis.qdi.logic2.LOGIC2_1.2 \decoder9_RTL_BODY.g552 ( 
    ...
    .\X.0 ( \n_76.0 ), 
    .\X.1 ( \n_76.1 ));
  \synthesis.qdi.logic2.LOGIC2_1.2 \decoder9_RTL_BODY.g559 ( 
    ...
    .\X.0 ( \n_57.0 ), 
    .\X.1 ( \n_57.1 ));
  \synthesis.qdi.special.CTREE2.2 \ctreedecoder9_RTL_BODY.g559 ( 
    .x ( \pchb_cloud_53_inst_en3 ), 
    .\a[0] ( \pchb_cloud_53_inst_go ), 
    .\a[1] ( \c20.e ));
  \synthesis.qdi.logic2.LOGIC2_1.2 \decoder9_RTL_BODY.g564 ( 
  ...
  \synthesis.qdi.special.CTREE4.2 \ctreedecoder9_RTL_BODY.g551 ( 
    .\a[0] ( \pchb_cloud_53_inst_go ), 
    .\a[1] ( \c17.e ), 
    .\a[2] ( \c39.e ), 
    .\a[3] ( \c36.e ), 
    .x ( \pchb_cloud_53_inst_en0 ));
  \synthesis.qdi.logic2.LOGIC2_1.2 \decoder9_RTL_BODY.g553 ( 
    ...
    .\X.0 ( \n_58.0 ), 
    .\X.1 ( \n_58.1 ));
  \synthesis.qdi.logic2.LOGIC2_1.2 \decoder9_RTL_BODY.g554 ( 
    ...
    .\X.0 ( \n_80.0 ), 
    .\X.1 ( \n_80.1 ));
  \synthesis.qdi.logic2.LOGIC2_1.2 \decoder9_RTL_BODY.g557 ( 
    ...
    .\X.0 ( \n_77.0 ), 
    .\X.1 ( \n_77.1 ));
  \synthesis.qdi.logic2.LOGIC2_1.2 \decoder9_RTL_BODY.g563 ( 
    ...
    .\X.0 ( \n_61.0 ), 
    .\X.1 ( \n_61.1 ));
  \synthesis.qdi.special.CTREE2.2 \ctreedecoder9_RTL_BODY.g563 ( 
  ...
  \synthesis.qdi.special.CTREE4.2 \ctreedecoder9_RTL_BODY.g553 ( 
    .\a[0] ( \pchb_cloud_54_inst_go ), 
    .\a[1] ( \c19.e ), 
    .\a[2] ( \c38.e ), 
    .\a[3] ( \c35.e ), 
    .x ( \pchb_cloud_54_inst_en0 ));
  \synthesis.qdi.logic2.LOGIC2_1.2 \decoder9_RTL_BODY.g555 ( 
    ...
    .\X.0 ( \n_56.0 ), 
    .\X.1 ( \n_56.1 ));
  \synthesis.qdi.logic2.LOGIC2_1.2 \decoder9_RTL_BODY.g560 ( 
    ...
    .\X.0 ( \n_75.0 ), 
    .\X.1 ( \n_75.1 ));
  \synthesis.qdi.logic2.LOGIC2_1.2 \decoder9_RTL_BODY.g561 ( 
    ...
    .\X.0 ( \n_78.0 ), 
    .\X.1 ( \n_78.1 ));
  \synthesis.qdi.logic2.LOGIC2_1.2 \decoder9_RTL_BODY.g562 ( 
    ...
    .\X.0 ( \n_59.0 ), 
    .\X.1 ( \n_59.1 ));
  \synthesis.qdi.special.CTREE2.2 \ctreedecoder9_RTL_BODY.g562 ( 
  ...
  \synthesis.qdi.special.CTREE4.2 \ctreedecoder9_RTL_BODY.g555 ( 
    .\a[0] ( \pchb_cloud_55_inst_go ), 
    .\a[1] ( \c22.e ), 
    .\a[2] ( \c41.e ), 
    .\a[3] ( \c37.e ), 
